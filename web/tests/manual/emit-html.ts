...
export function writeGuideHtml(sections: Section[], scenes: Scene[]): void {
...
<title>Overture Beginner Guide</title>
<!-- Generated by \`pnpm -C web manual:generate\`. Edit web/tests/manual/ to change it. -->
<style>${STYLE}</style>
</head>
<body>
<div class="wrap">
<header class="brand"><span class="name">OVERTURE</span><span class="sub">BEGINNER GUIDE</span></header>
${navHtml}
<main>
${content.intro.map((p) => `<p class="intro">${inline(p)}</p>`).join("\n")}
