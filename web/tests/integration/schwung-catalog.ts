  ...
  return {
    modules: [
      ...
      module("aurora", "Aurora", "sound_generator", [
        { key: "gain", name: "Gain", type: "float", min: 0, max: 1, default: 0.5 },
        { key: "tone", name: "Tone", type: "enum", options: ["Dark", "Bright"], min: 0, max: 1, default: 0 },
        { key: "filter_env_depth", name: "Filter Env Depth", type: "float", rangeMin: -100, rangeMax: 100, default: 20 },
        { key: "enabled", name: "Enabled", type: "bool", min: 0, max: 1, default: 1 },
        { key: "drive", name: "Drive", type: "float", min: 0, max: 1, default: 0.25 },
        { key: "attack", name: "Attack", type: "float", min: 0, max: 1, default: 0.02 },
        { key: "decay", name: "Decay", type: "float", min: 0, max: 1, default: 0.4 },
        { key: "release", name: "Release", type: "float", min: 0, max: 1, default: 0.7 },
        { key: "stereo_width", name: "Stereo Width", type: "float", min: 0, max: 1, default: 0.8 },
        { key: "output_level", name: "Output Level", type: "float", min: 0, max: 1, default: 0.9 },
      ], [
      ...
      module("freeverb", "Freeverb", "audio_fx", [
        { key: "mix", name: "Mix", type: "float", min: 0, max: 1, default: 0.28 },
        { key: "room_size", name: "Room Size", type: "float", min: 0, max: 1, default: 0.64 },
        { key: "damping", name: "Damping", type: "float", min: 0, max: 1, default: 0.42 },
        { key: "width", name: "Width", type: "float", min: 0, max: 1, default: 0.9 },
        { key: "predelay", name: "Pre-delay", type: "float", min: 0, max: 250, default: 18 },
        { key: "low_cut", name: "Low Cut", type: "float", min: 20, max: 1000, default: 180 },
        { key: "mod_depth", name: "Mod Depth", type: "float", min: 0, max: 1, default: 0.12 },
