...
| Control input interpretation           | `src/application/controls/`                                                                                                    | `control-input-interpreter.ts`, `types.ts`                                                | Root view control contexts                                                              | dependency-cruiser controls/intents rules     |
